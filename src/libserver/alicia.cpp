      ...
      case AcCmdCLLogin:
        {
          ...
          response.data = {
            0xC2, 0x08, 0x40, 0xA7, 0xF2, 0xB7, 0xDA, 0x01,  
            0x94, 0xA7, 0x0C, 0x00, 
            0xE8, 0xE2, 0x06, 0x00, // Character ID
            0x72, 0x67, 0x6E, 0x74, 0x00, // Character name ("rgnt\0")
            ...
            0x00, // Unk3: List size, max 16 elements
                  // This list would contain two 4 byte fields (even though the struct is of size 16?)
            ...
            // & 16 != 0: No idea what this is, just a single 4 byte value
            0x64, 0x00, 0x00, 0x00,

            // & 32 != 0: More keybinds (Not present in this packet)
            ...
            // Unk13: A small structure
            0x6D, 0xC9, 0xD7, 0x15, // Unk13.Unk0
            0x39, 0x89, // Unk13.Unk1
